...
//     try {
//       const { question, options, expiresAt, visibility } = req.body;
...
//     try {
//       const { id } = req.params;
//       const { question, options, expiresAt, visibility, isActive } = req.body;
...
//       // Don't allow updates if poll has votes (except for isActive and expiresAt)
